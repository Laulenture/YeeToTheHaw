...
namespace OpenCVForUnityExample
{
    ...
    public class HandPoseEstimationExample : MonoBehaviour
    {
        ...
        //recuperation des coordonée x et y de la position des mains
        public Rect2d mainPos;

        //Savoir si on a le poing fermé ou non
        public bool poingFermer = false;
        ...
        void Update ()
        {
            ...
            if (Input.GetMouseButtonUp (0) && !EventSystem.current.IsPointerOverGameObject ()) {
                ...
                //Une fois la main selectionner, l'affichage du webcam sort du champ de vision de la camera
...
//            Debug.Log ("Contours count: " + contours.Count);
            ...
            mainPos.x = boundRect.br().x;
            mainPos.y = boundRect.br().y;
            mainPos.height = 1;
            mainPos.width = 1;
